    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto pt-20">
          ...
          <h1 className="text-3xl sm:text-2xl md:text-3xl font-bold text-white mb-4 leading-tight">Conference Schedule</h1>
      ...
      <section className="py-8 bg-black">
        <div className="max-w-4xl mx-auto px-4">
          <FadeIn className="text-center mb-6">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-3">Your Weekend at a Glance</h2>
            <div className="w-10 h-0.5 bg-orange-500 mx-auto" />
          </FadeIn>

          <FadeIn delay={0.1}>
            <div className="grid grid-cols-3 gap-2 max-w-2xl mx-auto mb-4">
      ...
      <section className="py-8 bg-white text-black">
        <div className="max-w-4xl mx-auto px-4">
          <FadeIn className="text-center mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-black mb-3">What Makes This Different</h2>
      ...
      {/* MEET OUR SPONSORS STRIP */}
      <section className="py-6 bg-black border-t border-white/5">
        <FadeIn className="max-w-3xl mx-auto px-4 text-center">
          <p className="text-white/50 text-[10px] uppercase tracking-[0.2em] mb-4">Meet Our Sponsors</p>
          <div className="flex flex-wrap items-center justify-center gap-3">
            {[
              ...
              <a
                ...
                className="group flex items-center justify-center rounded-lg bg-white/95 border border-white/10 p-2 h-12 w-20 hover:border-orange-500/60 hover:bg-white transition-all"
              >
                <img
                  src={s.src}
                  alt={s.name}
                  className="max-h-8 max-w-full w-auto object-contain group-hover:scale-105 transition-transform duration-300"
                  onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }}
                />
              </a>
            ))}
