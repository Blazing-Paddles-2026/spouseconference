          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {[
              ...
              <a
                ...
                className="group flex items-center justify-center rounded-md bg-white/95 border border-white/10 p-1.5 h-14 w-20 hover:border-orange-500/60 hover:bg-white transition-all"
              >
                <img
                  src={s.src}
                  alt={s.name}
                  className="max-h-10 max-w-full w-auto object-contain group-hover:scale-105 transition-transform duration-300"
